...
6. [Implementation Deep Dive](#implementation-deep-dive)
   - 6.1 [Block Metadata Design](#block-metadata-design)
   - 6.2 [Arena-Based Concurrency](#arena-based-concurrency)
   - 6.3 [Allocation Algorithm](#allocation-algorithm)
   - 6.4 [Deallocation & Coalescing](#deallocation--coalescing)
   - 6.5 [Large Block Handling](#large-block-handling)
   - 6.6 [Memory Alignment](#memory-alignment)
7. [Thread Safety Analysis](#thread-safety-analysis)
8. [Performance Characteristics](#performance-characteristics)
9. [Testing & Validation](#testing--validation)
10. [Real-World Considerations](#real-world-considerations)
11. [Comparison with Production Allocators](#comparison-with-production-allocators)
